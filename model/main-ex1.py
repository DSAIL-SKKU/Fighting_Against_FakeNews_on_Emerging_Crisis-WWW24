...
# Parameters
class Arg:
    random_seed: int = 3014  # Random Seed
    pretrained_model =  'xlnet-base-cased' 
    pretrained_tokenizer = 'xlnet-base-cased' 
    cache_dir = './cache' 
    

    train_data_path = './data/train_ex1.pkl'
    test_data_path = './data/test.pkl'

    train_edge_path = './data/train_ex1.npy'
...
class MyGraphDataset(Dataset):
    def __init__(self, xlnet_output, adj_mat, batch_size, batch_index):
        # input : xlnet_output (batch_size * 768(/+100))
        # edge -> adj_mat[:index,:index] 
        # index : if i-th batch, (current_edge) - (self.batch_size * batch_index)
